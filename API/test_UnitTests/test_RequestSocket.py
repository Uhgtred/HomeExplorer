"""
The API is not going to be developed any further at the moment, since it does not make sense to use it at the moment.
Later, if and when there are sensors installed to the robot it will probably be reactivated.
"""
# #!/usr/bin/env python3
